...
export const Article0 = () => {
    return (
            <>  
                <div className="pg1 paginas">
                    <h2>Catálogo de Señales Verticales de Circulación</h2>
                    <div className="pg1body">
                        <h2>Tomo I</h2>
                        <h2>Definición de las señales</h2>
                    </div>
                    <div className="pg1footer">
                        <h3>Real Decreto 465/2025, de 10 de junio, por el que se modifica el Reglamento 
                            General de Circulación, aprobado por Real Decreto 1428/2003, de 21 de noviembre, 
                            en materia de señalización de tráfico.</h3>
                        <h3>17 de junio 2025</h3>
                    </div>
                </div>
                <div className="pg2 paginas">
                    <div className="contentpg2">
                        <span className="title1">
                            CATÁLOGO DE SEÑALES VERTICALES DE CIRCULACIÓN
                        </span>
                        <h2>Tomo I</h2>
                        <span className="title2">Definición de las señales</span>
                        <table className="indice">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>2.1</td>
                                    <td>Sistemas de colocación.</td>
                                </tr>
                                <tr>
                                    <td>2.2</td>
                                    <td>Señales dentro de carteles acompañadas de texto.</td>
                                </tr>
                                <tr>
                                    <td>2.3</td>
                                    <td>Paneles complementarios con la palabra &lt;&lt;EXCEPTO&gt;&gt;. </td>
                                </tr>
                                <tr>
                                    <td>2.4</td>
                                    <td>Utilización de dispositivos LED en señales verticales.</td>
                                </tr>
                                <tr>
                                    <td>2.5</td>
                                    <td>Señalización en tramos con obras o tareas de conservación.</td>
                                </tr>
                                <tr>
                                    <td>2.6</td>
                                    <td>Señalización circunstancial.</td>
                                </tr>
                                <tr>
                                    <td>2.7</td>
                                    <td>Señales de carriles sin regulación específica de velocidad.</td>
                                </tr>
                                <tr>
                                    <td>2.8</td>
                                    <td>Plazas de aparcamiento reservadas para personas con movilidad reducida.</td>
                                </tr>
                                <tr>
                                    <td>2.9</td>
                                    <td>Diseño de las señales de control.</td>
                                </tr>
                                <tr>
                                    <td>2.10</td>
                                    <td>Señales referidas a la circulación de ciclos.</td>
                                </tr>
                                <tr>
                                    <td>2.11</td>
                                    <td>Itinerarios alternativos para ciclos en autovías.</td>
                                </tr>
                                <tr>
                                    <td>3</td>
                                    <td>Tipos de señales.</td>
                                </tr>
                                <tr>
                                    <td>3.1</td>
                                    <td>Señales de advertencia de peligro.</td>
                                </tr>
                                <tr>
                                    <td>3.2</td>
                                    <td>Señales de prioridad.</td>
                                </tr>
                                <tr>
                                    <td>3.3</td>
                                    <td>Señales de prohibición de entrada.</td>
                                </tr>
                                <tr>
                                    <td>3.4</td>
                                    <td>Señales de restricción de paso.</td>
                                </tr>
                                <tr>
                                    <td>3.5</td>
                                    <td>Otras señales de prohibición y restricción.</td>
                                </tr>
                                <tr>
                                    <td>3.6</td>
                                    <td>Señales de obligación.</td>
                                </tr><tr>
                                    <td>3.7</td>
                                    <td>Señales de fin de prohibición, restricción u obligación.</td>
                                </tr><tr>
                                    <td>3.8</td>
                                    <td>Señales de indicaciones generales.</td>
                                </tr><tr>
                                    <td>3.9</td>
                                    <td>Señales de carriles.</td>
                                </tr><tr>
                                    <td>3.10</td>
                                    <td>Señales de servicio.</td>
                                </tr><tr>
                                    <td>3.11</td>
                                    <td>Señales de preseñalización.</td>
                                </tr><tr>
                                    <td>3.12</td>
                                    <td>Señales de dirección.</td>
                                </tr><tr>
                                    <td>3.13</td>
                                    <td>Señales de identificación de carreteras.</td>
                                </tr><tr>
                                    <td>3.14</td>
                                    <td>Señales de localización.</td>
                                </tr><tr>
                                    <td>3.15</td>
                                    <td>Señales de confirmación.</td>
                                </tr><tr>
                                    <td>3.16</td>
                                    <td>Señales de uso específico en poblado.</td>
                                </tr>
                                <tr>
                                    <td>3.17</td>
                                    <td>Paneles complementarios.</td>
                                </tr>
                                <tr>
                                    <td>3.18</td>
                                    <td>Otras señales.</td>
                ...
                <div className="pg3 paginas">
                    <div className="innerpg3">
                        <p>&nbsp;&nbsp;&nbsp;&nbsp;1.&nbsp;&nbsp;&nbsp;&nbsp;<span className="title">Introducción</span></p>
                        <p className="text">
                            &nbsp;&nbsp;&nbsp;&nbsp;En este tomo I del Catálogo de señales verticales de circulación 
                            se establece el código, nombre y definición de cada una de las señales
                            verticales de circulación.
                        </p>
                        <p>&nbsp;&nbsp;&nbsp;&nbsp;2.&nbsp;&nbsp;&nbsp;&nbsp;<span className="title">Caractirísticas generales.</span></p>
                        <p>&nbsp;&nbsp;&nbsp;&nbsp;2.1&nbsp;&nbsp;&nbsp;&nbsp;<span className="title">Sistemas de colocación.</span></p>
                        <p className="text">&nbsp;&nbsp;&nbsp;&nbsp;
                            Los dispositivos específicos de sustentación se clasifican en postes,
                            banderolas y pórticos; puntualmente se pueden utilizar otros, como 
                            obras de paso o muros, cuya función específica sea diferente.
                        </p>
                        <p className="text">&nbsp;&nbsp;&nbsp;&nbsp;- Pórticos: es una estructura formada por un dintel y 
                            apoyada a ambos lados de la plataforma, que sirve para soportar las señales.
                        </p>
                        <p className="text">&nbsp;&nbsp;&nbsp;&nbsp;- Banderola: es una estructura en forma de ménsula apoyada 
                            a un solo lado de la plataforma, que sirve para soportar las señales. 
                        </p>
                        <p className="text">&nbsp;&nbsp;&nbsp;&nbsp;- Poste: elemento tubular o rectangular apoyado a un 
                            solo lado de la plataforma, que sirve para soportar las señales.
                        </p>
                        <p>&nbsp;&nbsp;&nbsp;&nbsp;2.2&nbsp;&nbsp;&nbsp;&nbsp;<span className="title">Señales dentro de carteles acompañadas de texto.</span></p>
                        <p className="text">&nbsp;&nbsp;&nbsp;&nbsp;
                            ...
                            limitaciones, periodos de aplicación o alcance a determinados tipos de vehículos
                            o personas usuarias.
                        </p>
                        <p>&nbsp;&nbsp;&nbsp;&nbsp;2.3&nbsp;&nbsp;&nbsp;&nbsp;<span className="title">Paneles complementarios con la palabra &lt;&lt;EXCEPTO&gt;&gt;.</span></p>
                        <p className="text">&nbsp;&nbsp;&nbsp;&nbsp;
                        ...
                        <p>&nbsp;&nbsp;&nbsp;&nbsp;2.4&nbsp;&nbsp;&nbsp;&nbsp;<span className="title">Utilización de dispositivos LED en señales verticales.</span></p>
                        <p className="text">&nbsp;&nbsp;&nbsp;&nbsp;
                            ...
                            en su interior. Estos serán de color blanco, amarillo o ámbar, y serán comformes a 
                            la normativa, tanto de ámbito nacional como internacional, de aplicación.
                        </p>
                        <p>&nbsp;&nbsp;&nbsp;&nbsp;2.5&nbsp;&nbsp;&nbsp;&nbsp;<span className="title">Señalización en tramos con obras o tareas de conservación.</span></p>
                        <p className="text">&nbsp;&nbsp;&nbsp;&nbsp;
                            ...
                            fondo sea en su versión convencional de color blacnco, estas tendrán fondo 
                            amarillo. Concretamente, estas señales son siguientes:
                        </p>
                        <div className="señalespeligrosas">
                            <p className="text">&nbsp;&nbsp;&nbsp;&nbsp;- Todas las señales de peligro <span className="ns">(P-1 a P-50).</span></p>
                            <p className="text">&nbsp;&nbsp;&nbsp;&nbsp;- Las señales de prioridad <span className="ns">R-1 y R-5.</span></p>
                            <p className="text">&nbsp;&nbsp;&nbsp;&nbsp;- Todas las señales de prohibición de entrada <span className="ns">(R-100 a R-120)</span>
                            con excepción de la <span className="ns">R-101.</span></p>
                            <p className="text">&nbsp;&nbsp;&nbsp;&nbsp;- Todas las señales de restricción de paso <span className="ns">(R-200 a R-205).</span></p>
                            <p className="text">&nbsp;&nbsp;&nbsp;&nbsp;- Las señales comprendidas entre los códigos <span className="ns">R-300 y R-306</span>, 
                            ambas incluidas</p>
                            <p className="text">&nbsp;&nbsp;&nbsp;&nbsp;- Las señales de fin de prohibición, restricción u obligación comprendidas entre
                                los códigos <span className="ns">R-500 y R-504</span>.</p>
                        </div>
                    </div>
                </div>
                <div className="pg4 paginas">
                    <div className="innerpg4">
                        <p className="text">&nbsp;&nbsp;&nbsp;&nbsp;Cuando se dispongan señales de carriles <span className="ns">(S-50 a S-73)</span>, 
                        el fondo será amarillo en lugar de azul, y los símbolos, negros en lugar de blancos.<br></br>
                        ...
                        adhesivos negros.</p>
                        <p>&nbsp;&nbsp;&nbsp;&nbsp;2.6&nbsp;&nbsp;&nbsp;&nbsp;
                            <span className="title">Señalización circunstancial</span>. 
                        </p>
                        <p className="text">&nbsp;&nbsp;&nbsp;&nbsp;
                        ...
                        <p>&nbsp;&nbsp;&nbsp;&nbsp;2.7&nbsp;&nbsp;&nbsp;&nbsp;
                            <span className="title">Señales de carriles sin regulación específica de velocidad</span>.
                        </p>
                        <p className="text">&nbsp;&nbsp;&nbsp;&nbsp;
                            ...
                            los casos en los que no se establece una regulación especifíca de velocidad en 
                            ellos, podrán utilizarse las señales de carriles <span className="ns">S-50a, S-50b, 
                                S-50c, S-50d, S-50e, S-53a y S-53c </span>suprimiendo alguna o todas las señales
                                <span className="ns"> R-411 </span>Velocidad mínima o <span className="ns">R-301 </span>
                                Velocidad máxima que en ellas figuran.
                        </p>
                        <p>&nbsp;&nbsp;&nbsp;&nbsp;2.8&nbsp;&nbsp;&nbsp;&nbsp;
                            <span className="title">Plazas de aparcamiento reservadas para personas con movilidad reducida.</span>
                        </p>
                        <p className="text">&nbsp;&nbsp;&nbsp;&nbsp;
                            ...
                            accesibilidad para la movilidad. Reglas y grados de uso; bien con una señal <span className="ns">S-17 </span>
                            Estacionamiento que incluya el Símbolo de accesibilidad para la movilidad.
                        </p>
                        <p>&nbsp;&nbsp;&nbsp;&nbsp;2.9&nbsp;&nbsp;&nbsp;&nbsp;
                            <span className="title">Diseño de las señales de control.</span>
                        </p>
                        <p className="text">&nbsp;&nbsp;&nbsp;&nbsp;
                            En el diseño de las señales de indicación de existencia de un dispositivo de 
                            control de velocidad, semáforo en rojo o STOP (señales <span className="ns">S-991</span>), se podrán 
                            suprirmir algunos o todos los vehículos cuando se considere que de ese modo se 
                            facilita la percepción de la señal (especialmente cuando esta sea de un tamaño 
                            relativamente pequeño).  
                        </p>
                        <p>&nbsp;&nbsp;&nbsp;&nbsp;2.10&nbsp;&nbsp;&nbsp;&nbsp;
                            <span className="title">Señales referidas a la circulación de ciclos.</span>
                        </p>
                        <p className="text">&nbsp;&nbsp;&nbsp;&nbsp;
                        ...
                        <p>&nbsp;&nbsp;&nbsp;&nbsp;2.11&nbsp;&nbsp;&nbsp;&nbsp;
                            <span className="title">Itinerarios alternativos para ciclos en autovías.</span>
                        </p>
                        <p className="text">&nbsp;&nbsp;&nbsp;&nbsp;
                            ...
                            disponer un panel complementario <span className="ns">S-860 </span>en el que se indique claramente la 
                ...
                <div className="pg5 paginas">
                    <div className="innerpg5">
                        <div className="headerpg5">
                            <img src="/Escudo_de_España_(contornos).svg.png" alt="" />
                            <div className="line1">
                                {/* <div className="svgEscudo">
	                                <svg xmlns="http://www.w3.org/2000/svg" width="640" height="480" viewBox="0 0 640 480">
		                                <path fill="#aa151b" d="M0 0h640v480H0z" />
		                                <path fill="#f1bf00" d="M0 120h640v240H0z" />
		                                <path fill="none" d="m127.3 213.3l-.8-.1l-1-1l-.7-.4l-.6-.8s-.7-1.1-.4-2q.5-1.2 1.4-1.5l1.5-.5l1-.4l1.3-.3l.5-.3l1-.2l1-.2l1.6.1h4.8c.4 0 1.2.3 1.4.4l2 .7c.5.1 1.6.3 2.2.6q.8.5 1.1 1l.5 1v1.1l-.5.8l-.6 1l-.8.6s-.5.5-1 .4s-4.8-.8-7.6-.8s-7.3.9-7.3.9" />
		                                <path fill="none" stroke="#000" stroke-linejoin="round" stroke-width="0.3" d="m127.3 213.3l-.8-.1l-1-1l-.7-.4l-.6-.8s-.7-1.1-.4-2q.5-1.2 1.4-1.5l1.5-.5l1-.4l1.3-.3l.5-.3l1-.2l1-.2l1.6.1h4.8c.4 0 1.2.3 1.4.4l2 .7c.5.1 1.6.3 2.2.6q.8.5 1.1 1l.5 1v1.1l-.5.8l-.6 1l-.8.6s-.5.5-1 .4s-4.8-.8-7.6-.8s-7.3.9-7.3.9z" />
		                                <path fill="none" d="M133.3 207q.1-2.1 1.3-2.3q1.3.1 1.4 2.4c0 1.3-.6 2.4-1.4 2.4s-1.3-1.1-1.3-2.5" />
		                                ...
		                                <path fill="none" d="M134 207q0-2 .7-2.1c.3 0 .6 1 .6 2.1q0 2-.6 2.2c-.4 0-.6-1-.6-2.2" />
		                                <path fill="none" stroke="#000" stroke-width="0.3" d="M134 207q0-2 .7-2.1c.3 0 .6 1 .6 2.1q0 2-.6 2.2c-.4 0-.6-1-.6-2.2z" />
		                                <path fill="none" d="M133.8 204.5q.1-.7.8-.8q1 0 1 .8q-.1.8-1 .9c-.9.1-.8-.4-.8-.9" />
		                                <path fill="none" d="M135.3 204.2v.6h-1.4v-.6h.5V203h-.7v-.6h.7v-.5h.5v.5h.6v.6h-.6v1.2z" />
		                                <path fill="none" stroke="#000" stroke-width="0.3" d="M135.3 204.2v.6h-1.4v-.6h.5V203h-.7v-.6h.7v-.5h.5v.5h.6v.6h-.6v1.2h.4" />
		                                <path fill="none" d="M135.9 204.2v.6h-2.5v-.6h1V203h-.7v-.6h.7v-.5h.5v.5h.6v.6h-.6v1.2z" />
		                                ...
		                                <path fill="none" d="M134.7 213.2H130v-1.1l-.3-1.2l-.2-1.5c-1.3-1.7-2.5-2.8-2.9-2.5q.1-.5.5-.7c1.1-.7 3.5 1 5.2 3.6l.5.7h3.8l.4-.7c1.8-2.7 4.1-4.3 5.2-3.6q.4.2.5.7c-.4-.3-1.6.8-2.9 2.5l-.2 1.5l-.2 1.2l-.1 1.1z" />
		                                ...
		                                <path fill="none" d="m127.8 215.3l-.5-1a27 27 0 0 1 14.7 0l-.5.8l-.3.8a23 23 0 0 0-6.6-.8c-2.6 0-5.2.3-6.5.8z" />
		                                ...
		                                <path fill="none" d="M134.6 217.7c2.4 0 5-.4 5.9-.6q1-.3 1-.8q0-.3-.4-.4c-1.4-.5-4-.8-6.5-.8s-5 .3-6.4.8q-.3 0-.4.3q0 .6 1 .9c1 .2 3.5.6 5.8.6" />
		                                ...
		                                <path fill="none" d="m142.1 213.2l-.5-.5s-.6.3-1.3.2c-.6 0-.9-1-.9-1s-.7.7-1.3.7s-1-.6-1-.6s-.7.5-1.3.4s-1.2-.8-1.2-.8s-.6.8-1.2.8c-.6.1-1-.5-1-.5s-.4.6-1.1.7s-1.4-.6-1.4-.6s-.5.7-1 1c-.5 0-1.2-.4-1.2-.4l-.2.5l-.3.1l.2.5a27 27 0 0 1 7.2-.9q4.5 0 7.4 1z" />
		                                ...
		                                <path fill="none" d="M134.7 210.7h.2v.4q0 1 1 1a1 1 0 0 0 1-.7l.2-.3v.4q.3.8 1.1.8q1 0 1-1v-.1l.4-.4l.2.5l-.1.4a1 1 0 0 0 1 1q.6 0 .9-.5l.2-.2v.3q0 .5.4.7l1-.4l.7-.7v.4s-.5.8-1 1q-.3.4-.8.3q-.5 0-.7-.6q-.3.3-.7.2q-1 0-1.4-.8q-.5.5-1.1.5a2 2 0 0 1-1.2-.6l-1 .4a2 2 0 0 1-1.3-.6a1.6 1.6 0 0 1-2.4.2a2 2 0 0 1-1.2.6l-1.1-.5q-.4.8-1.4.8l-.7-.2q-.2.5-.7.6t-.9-.2l-1-1l.1-.5l.8.7q.8.5.9.4q.4-.1.4-.7v-.3l.2.2q.3.5.9.5a1 1 0 0 0 1-1v-.9l.4.4v.1q.1 1 1 1t1.1-.9v-.3l.2.3q.3.6 1 .7q1 0 1.1-1v-.3h.3" />
		                                <path fill="none" stroke="#000" stroke-width="0.3" d="M134.7 210.7h.2v.4q0 1 1 1a1 1 0 0 0 1-.7l.2-.3v.4q.3.8 1.1.8q1 0 1-1v-.1l.4-.4l.2.5l-.1.4a1 1 0 0 0 1 1q.6 0 .9-.5l.2-.2v.3q0 .5.4.7l1-.4l.7-.7v.4s-.5.8-1 1q-.3.4-.8.3q-.5 0-.7-.6q-.3.3-.7.2q-1 0-1.4-.8q-.5.5-1.1.5a2 2 0 0 1-1.2-.6l-1 .4a2 2 0 0 1-1.3-.6a1.6 1.6 0 0 1-2.4.2a2 2 0 0 1-1.2.6l-1.1-.5q-.4.8-1.4.8l-.7-.2q-.2.5-.7.6t-.9-.2l-1-1l.1-.5l.8.7q.8.5.9.4q.4-.1.4-.7v-.3l.2.2q.3.5.9.5a1 1 0 0 0 1-1v-.9l.4.4v.1q.1 1 1 1t1.1-.9v-.3l.2.3q.3.6 1 .7q1 0 1.1-1v-.3h.3z" />
		                                <path fill="none" d="M134.6 213.3q-4.5 0-7.3 1l-.3-.2l.1-.3a27 27 0 0 1 7.5-1q4.6 0 7.6 1l.1.3l-.3.2a27 27 0 0 0-7.4-1" />
		                                <path fill="none" stroke="#000" stroke-linejoin="round" stroke-width="0.3" d="M134.6 213.3q-4.5 0-7.3 1l-.3-.2l.1-.3a27 27 0 0 1 7.5-1q4.6 0 7.6 1l.1.3l-.3.2a27 27 0 0 0-7.4-1z" />
		                                <path fill="none" d="M131.8 214.4q0-.4.5-.4a.4.4 0 0 1 .4.4q0 .3-.4.4a.4.4 0 0 1-.5-.4" />
		                                <path fill="none" stroke="#000" stroke-width="0.3" d="M131.8 214.4q0-.4.5-.4a.4.4 0 0 1 .4.4q0 .3-.4.4a.4.4 0 0 1-.5-.4z" />
		                                <path fill="none" d="M134.7 214.5h-1q-.2 0-.3-.3l.3-.3h2l.2.3l-.3.3h-1" />
		                                <path fill="none" stroke="#000" stroke-width="0.3" d="M134.7 214.5h-1q-.2 0-.3-.3l.3-.3h2l.2.3l-.3.3h-1" />
		                                <path fill="none" d="M130 214.9h-.7q-.2 0-.3-.2l.2-.3l.7-.1l.7-.1q.3 0 .4.2a.3.3 0 0 1-.3.4z" />
		                                <path fill="none" stroke="#000" stroke-width="0.3" d="M130 214.9h-.7q-.2 0-.3-.2l.2-.3l.7-.1l.7-.1q.3 0 .4.2a.3.3 0 0 1-.3.4h-.7" />
		                                <path fill="none" d="m127.3 215.3l.3-.4h.7l-.4.6z" />
		                                <path fill="none" stroke="#000" stroke-width="0.3" d="m127.3 215.3l.3-.4h.7l-.4.6l-.6-.2" />
		                                <path fill="none" d="M136.6 214.4q0-.4.4-.4a.4.4 0 0 1 .5.4a.4.4 0 0 1-.5.4a.4.4 0 0 1-.4-.4" />
		                                <path fill="none" stroke="#000" stroke-width="0.3" d="M136.6 214.4q0-.4.4-.4a.4.4 0 0 1 .5.4a.4.4 0 0 1-.5.4a.4.4 0 0 1-.4-.4z" />
		                                <path fill="none" d="M139.3 214.9h.6a.3.3 0 0 0 .4-.2l-.3-.3l-.6-.1l-.7-.1q-.3 0-.4.2q0 .3.3.4z" />
		                                <path fill="none" stroke="#000" stroke-width="0.3" d="M139.3 214.9h.6a.3.3 0 0 0 .4-.2l-.3-.3l-.6-.1l-.7-.1q-.3 0-.4.2q0 .3.3.4h.7" />
		                                <path fill="none" d="m142 215.4l-.3-.5h-.7l.3.6z" />
		                                <path fill="none" stroke="#000" stroke-width="0.3" d="m142 215.4l-.3-.5h-.7l.3.6l.6-.1" />
		                                <path fill="none" d="M134.6 217.1a25 25 0 0 1-6-.6a26 26 0 0 1 12.1 0q-2.5.6-6 .6" />
		                                ...
		                                <path fill="none" d="m142 212l-.1-.3q-.3 0-.4.2q0 .4.2.4z" />
		                                <path fill="none" stroke="#000" stroke-width="0.3" d="m142 212l-.1-.3q-.3 0-.4.2q0 .4.2.4z" />
		                                <path fill="none" d="M137.3 211.2q0-.3-.2-.4l-.2.3q0 .3.2.4l.3-.3" />
		                                <path fill="none" stroke="#000" stroke-width="0.3" d="M137.3 211.2q0-.3-.2-.4l-.2.3q0 .3.2.4l.3-.3z" />
		                                <path fill="none" d="m132 211.2l.1-.4q.3 0 .3.3t-.2.4z" />
		                                <path fill="none" stroke="#000" stroke-width="0.3" d="m132 211.2l.1-.4q.3 0 .3.3t-.2.4z" />
		                                <path fill="none" d="m127.3 212l.1-.3q.3 0 .4.2q0 .4-.2.4z" />
		                                <path fill="none" stroke="#000" stroke-width="0.3" d="m127.3 212l.1-.3q.3 0 .4.2q0 .4-.2.4z" />
		                                <path fill="none" d="m134.6 208.5l-.8.5l.6 1.3l.2.1l.2-.1l.7-1.3z" />
		                                <path fill="none" stroke="#000" stroke-width="0.3" d="m134.6 208.5l-.8.5l.6 1.3l.2.1l.2-.1l.7-1.3l-.9-.5" />
		                                <path fill="none" d="m132.8 210.5l.4.5l1.3-.4l.1-.2l-.1-.2l-1.3-.3z" />
		                                <path fill="none" stroke="#000" stroke-width="0.3" d="m132.8 210.5l.4.5l1.3-.4l.1-.2l-.1-.2l-1.3-.3l-.4.6" />
		                                <path fill="none" d="m136.4 210.5l-.3.5l-1.3-.4l-.2-.2l.2-.2l1.3-.3z" />
		                                <path fill="none" stroke="#000" stroke-width="0.3" d="m136.4 210.5l-.3.5l-1.3-.4l-.2-.2l.2-.2l1.3-.3l.3.6" />
		                                <path fill="none" d="m129.3 209l-.7.7l.9 1l.2.1l.1-.1l.3-1.3z" />
		                                <path fill="none" stroke="#000" stroke-width="0.3" d="m129.3 209l-.7.7l.9 1l.2.1l.1-.1l.3-1.3l-.8-.3" />
		                                <path fill="none" d="m128 211.2l.4.5l1.2-.6v-.2l-.1-.2l-1.3-.1l-.3.6" />
		                                <path fill="none" stroke="#000" stroke-width="0.3" d="m128 211.2l.4.5l1.2-.6v-.2l-.1-.2l-1.3-.1l-.3.6" />
		                                <path fill="none" d="m131.5 210.5l-.3.6H130l-.2-.2l.1-.3l1.2-.6z" />
		                                <path fill="none" stroke="#000" stroke-width="0.3" d="m131.5 210.5l-.3.6H130l-.2-.2l.1-.3l1.2-.6l.5.5" />
		                                <path fill="none" d="M126.6 211.4v.6l-1.4.2l-.2-.1v-.2l1-.9z" />
		                                <path fill="none" stroke="#000" stroke-width="0.3" d="M126.6 211.4v.6l-1.4.2l-.2-.1v-.2l1-.9l.6.4" />
		                                <path fill="none" d="M129.2 210.9q0-.5.5-.5t.5.5l-.5.4z" />
		                                <path fill="none" stroke="#000" stroke-width="0.3" d="M129.2 210.9q0-.5.5-.5t.5.5l-.5.4z" />
		                                <path fill="none" d="m140 209l.7.7l-.9 1l-.2.1l-.1-.1l-.3-1.3z" />
		                                <path fill="none" stroke="#000" stroke-width="0.3" d="m140 209l.7.7l-.9 1l-.2.1l-.1-.1l-.3-1.3l.8-.3" />
		                                <path fill="none" d="m141.4 211.2l-.5.5l-1.2-.6v-.2l.1-.2l1.3-.1z" />
		                                <path fill="none" stroke="#000" stroke-width="0.3" d="m141.4 211.2l-.5.5l-1.2-.6v-.2l.1-.2l1.3-.1l.3.6" />
		                                <path fill="none" d="m137.8 210.5l.3.6h1.3l.2-.2l-.1-.3l-1.2-.6z" />
		                                <path fill="none" stroke="#000" stroke-width="0.3" d="m137.8 210.5l.3.6h1.3l.2-.2l-.1-.3l-1.2-.6l-.5.5" />
		                                <path fill="none" d="m142.5 211.4l.1.6l1.3.2l.2-.1v-.2l-1-.9z" />
		                                <path fill="none" stroke="#000" stroke-width="0.3" d="m142.5 211.4l.1.6l1.3.2l.2-.1v-.2l-1-.9l-.6.4" />
		                                <path fill="none" d="m134.2 210.4l.4-.4q.5 0 .5.4l-.5.5z" />
		                                <path fill="none" stroke="#000" stroke-width="0.3" d="m134.2 210.4l.4-.4q.5 0 .5.4l-.5.5z" />
		                                <path fill="none" d="M139.1 210.9q.1-.5.5-.5l.5.5l-.5.4z" />
		                                <path fill="none" stroke="#000" stroke-width="0.3" d="M139.1 210.9q.1-.5.5-.5l.5.5l-.5.4z" />
		                                <path fill="none" d="m124.8 212.2l-.6-.7c-.2-.2-.7-.3-.7-.3q0-.2.6-.3l.4.2v-.2s.3 0 .4.3v1" />
		                                <path fill="none" stroke="#000" stroke-width="0.3" d="m124.8 212.2l-.6-.7c-.2-.2-.7-.3-.7-.3q0-.2.6-.3l.4.2v-.2s.3 0 .4.3v1z" />
		                                <path fill="none" d="M124.8 212q.3-.3.5 0t.2.5l-.5-.1q-.3-.2-.2-.5" />
		                                <path fill="none" stroke="#000" stroke-width="0.3" d="M124.8 212q.3-.3.5 0t.2.5l-.5-.1q-.3-.2-.2-.5z" />
		                                <path fill="none" d="m144.3 212.2l.6-.7l.7-.3q0-.2-.6-.3l-.4.2v-.2s-.3 0-.4.3v.7z" />
		                                <path fill="none" stroke="#000" stroke-width="0.3" d="m144.3 212.2l.6-.7l.7-.3q0-.2-.6-.3l-.4.2v-.2s-.3 0-.4.3v.7z" />
		                                <path fill="none" d="M144.3 212q-.1-.3-.5 0q-.3.2-.1.5l.5-.1q.3-.2.1-.5" />
		                                <path fill="none" stroke="#000" stroke-width="0.3" d="M144.3 212q-.1-.3-.5 0q-.3.2-.1.5l.5-.1q.3-.2.1-.5z" />
		                                <path fill="none" d="M124 223h21.4v-5.5H124z" />
		                                <path fill="none" stroke="#000" stroke-width="0.4" d="M124 223h21.4v-5.5H124z" />
		                                <path fill="none" d="M126.2 226.8h16.9a1.4 1.4 0 0 1-1-1.2q.1-1 1-1.3h-16.9q1 .3 1 1.3a1.3 1.3 0 0 1-1 1.2" />
		                                ...
		                                <path fill="none" d="M126.6 226.8h16q1 0 1 .7t-1 .8h-16q-.9-.1-1-.8q0-1 1-.8" />
		                                <path fill="none" stroke="#000" stroke-width="0.4" d="M126.6 226.8h16q1 0 1 .7t-1 .8h-16q-.9-.1-1-.8q0-1 1-.8z" />
		                                <path fill="none" d="M126.6 223h16q1 .1 1 .7t-1 .6h-16q-.9 0-1-.6q.1-.5 1-.6" />
		                                <path fill="none" stroke="#000" stroke-width="0.4" d="M126.6 223h16q1 .1 1 .7t-1 .6h-16q-.9 0-1-.6q.1-.5 1-.6z" />
		                                <path fill="none" d="M149.6 317.4q-2.2 0-3.7-.8a8 8 0 0 0-3.8-.8q-2.1 0-3.7.8a8 8 0 0 1-3.8.8q-2.3 0-3.7-.8a8 8 0 0 0-3.7-.8a8 8 0 0 0-3.7.8a8 8 0 0 1-3.8.8v2.4q2.3 0 3.8-.9a8 8 0 0 1 3.7-.8q2.2 0 3.7.8c1.5.8 2.2.9 3.7.9a8 8 0 0 0 3.8-.9q1.6-.8 3.7-.8q2.3 0 3.8.8c1.5.8 2.2.9 3.7.9z" />
		                                ...
		                                <path fill="none" stroke="#000" stroke-width="0.4" d="M126.8 267.3c-4.3-.3-7.3-1.4-7.6-3.2q-.3-2.2 3.8-4.5l3.8.3v7.4" />
		                                ...
		                                <path fill="#ad1519" d="M277.9 211.6s-.7.8-1.3.9c-.5 0-1.1-.5-1.1-.5s-.5.5-1 .6s-1.4-.6-1.4-.6l-1 1l-1.1-.3c-.1-.1-.3.4-.7.6h-.4l-.6-.4l-.7-.7l-.5-.3l-.4-1v-.5q0-1 2.2-1.7a4 4 0 0 1 2 0q.9-.8 3-.8c2.1 0 2.4.3 3 .7a6 6 0 0 1 2.9-.7q2.1 0 3 .8q.8-.3 2 0q2.2.6 2.2 1.7v.5l-.4 1l-.6.3l-.6.7l-.6.3s-.3.2-.4 0q-.6-.3-.7-.5c-.1-.2-.6.4-1 .2s-1-1-1-1s-.9.8-1.4.7c-.6-.1-1-.6-1-.6s-.7.6-1.2.5s-1.2-.9-1.2-.9" />
		                                <path fill="none" stroke="#000" stroke-width="0.3" d="M277.9 211.6s-.7.8-1.3.9c-.5 0-1.1-.5-1.1-.5s-.5.5-1 .6s-1.4-.6-1.4-.6l-1 1l-1.1-.3c-.1-.1-.3.4-.7.6h-.4l-.6-.4l-.7-.7l-.5-.3l-.4-1v-.5q0-1 2.2-1.7a4 4 0 0 1 2 0q.9-.8 3-.8c2.1 0 2.4.3 3 .7a6 6 0 0 1 2.9-.7q2.1 0 3 .8q.8-.3 2 0q2.2.6 2.2 1.7v.5l-.4 1l-.6.3l-.6.7l-.6.3s-.3.2-.4 0q-.6-.3-.7-.5c-.1-.2-.6.4-1 .2s-1-1-1-1s-.9.8-1.4.7c-.6-.1-1-.6-1-.6s-.7.6-1.2.5s-1.2-.9-1.2-.9z" />
		                                ...
		                                <path fill="#c8b100" d="M277.8 213.3q-4.5 0-7.3 1l-.3-.2l.1-.3q3-1 7.5-1t7.6 1l.1.3l-.3.2a27 27 0 0 0-7.4-1" />
		                                <path fill="none" stroke="#000" stroke-width="0.3" d="M277.8 213.3q-4.5 0-7.3 1l-.3-.2l.1-.3q3-1 7.5-1t7.6 1l.1.3l-.3.2a27 27 0 0 0-7.4-1z" />
		                                ...
		                                <path fill="none" stroke="#000" stroke-width="0.3" d="M280.6 211.2q0-.3-.3-.4l-.2.3q0 .3.2.4z" />
		                                ...
		                                <path fill="#c8b100" d="M272.4 210.9q0-.5.5-.5l.5.5l-.5.4z" />
		                                <path fill="none" stroke="#000" stroke-width="0.3" d="M272.4 210.9q0-.5.5-.5l.5.5l-.5.4z" />
		                                ...
		                                <path fill="#c8b100" d="M277.4 210.4q0-.3.5-.4q.4 0 .4.4t-.4.5z" />
		                                <path fill="none" stroke="#000" stroke-width="0.3" d="M277.4 210.4q0-.3.5-.4q.4 0 .4.4t-.4.5z" />
		                                <path fill="#c8b100" d="M282.3 210.9q.1-.5.5-.5t.5.5q0 .6-.5.4z" />
		                                <path fill="none" stroke="#000" stroke-width="0.3" d="M282.3 210.9q.1-.5.5-.5t.5.5q0 .6-.5.4z" />
		                                ...
		                                <path fill="transparent" d="M290.6 286.7c2.1 1.2 3.6 2.5 3.4 3.2q-.2.8-1.8 1.6c-1.6 1.1-2.5 3-1.8 4a5.5 5.5 0 0 1 .2-8.8" />
		                                ...
		                                <path fill="transparent" d="M254.2 257.7a50 50 0 0 1 23.3-2c9.3 1.6 16.4 5.3 15.9 8.4v.2l3.5-8.2c.6-3.3-7.3-7.5-17.6-9.2a54 54 0 0 0-9.2-.7c-6.7 0-12.4.8-15.9 2.1z" />
		                                ...
		                                <path fill="none" d="M285.7 267.3c4.4-.3 7.3-1.4 7.7-3.2q.2-2.2-3.8-4.5l-3.9.3z" />
		                                <path fill="none" stroke="#000" stroke-width="0.4" d="M285.7 267.3c4.4-.3 7.3-1.4 7.7-3.2q.2-2.2-3.8-4.5l-3.9.3v7.4" />
		                                <path fill="none" d="M270 261.5a13 13 0 0 0-5.7 1.9v.2c-.5 1 1.8 3 5.8 5.4v-7.5" />
		                                <path fill="none" stroke="#000" stroke-width="0.4" d="M270 261.5a13 13 0 0 0-5.7 1.9v.2c-.5 1 1.8 3 5.8 5.4v-7.5" />
		                                <path fill="none" d="M295.4 282c.4-1.2-3.8-3.6-9.7-5.8c-2.8-1-5-2-7.8-3.2c-8.3-3.7-14.4-7.9-13.6-9.4v-.2c-.4.4-1 8-1 8c-.8 1.3 4.8 5.5 12.4 9.1c2.4 1.2 7.6 3 10 4c4.3 1.4 8.7 4.3 8.3 5.3l1.4-7.7" />
		                                ...
		                                <path fill="#000" d="m263.9 254.4l2.1-6.6h-.5l-.5.1l-1.4 4.8q-1.6-2-2.7-4.1l-1 .2h-1l4 5.7h.5zm6-6.6h-1.8v6.2h4.2v-.7h-2.6zm6.8 1l2 .3v-.7l-5.8-.5v.8h2l-.4 5.6h1.6l.5-5.4m2.4 6l.8.2l.8.2l.7-2.9l.6 1.2l.8 2.1l1 .2q.6 0 1 .3l-.3-.7l-1.3-2.9q1.6 0 2.1-1.2q.3-.8-.7-1.5q-.8-.4-1.7-.5l-2.4-.5zm3-5.2c.7.2 1.5.3 1.5 1v.5q-.5 1.3-2 .9zm8 7l-.2 2l.8.5l.9.5l.5-7l-.7-.3l-6.1 3.8l.5.3l.4.2l1.7-1.2l2.3 1.3zm-1.7-1.5l2-1.4l-.2 2.3z" />
		                                <path fill="none" stroke="#000" stroke-width="0.1" d="M182.2 192.4c0-1 1-2 2-2s2.2 1 2.2 2c0 1.1-1 2-2.1 2a2 2 0 0 1-2.1-2z" />
		                                <path fill="none" stroke="#000" stroke-width="0.3" d="M205.7 175.4c6.3 0 12 1 15.7 2.4a32 32 0 0 0 14.6 2.3c2.7 0 6.5.8 10.3 2.4a27 27 0 0 1 7.4 4.7l-1.5 1.4l-.4 3.8l-4.1 4.7l-2 1.8l-5 3.9l-2.5.2l-.7 2.1l-31.6-3.7l-31.7 3.7l-.8-2.1l-2.5-.2l-4.9-4l-2-1.7l-4.1-4.7l-.5-3.8l-1.5-1.4a28 28 0 0 1 7.5-4.7a26 26 0 0 1 10.2-2.4q3 .3 6.6-.2a30 30 0 0 0 8-2q5.6-2.4 15.5-2.5z" />
		                                <path fill="none" stroke="#000" stroke-width="0.4" d="M206.2 217.1c-11.8 0-22.4-1.4-29.9-3.6a1 1 0 0 1-.8-1.2q0-.8.8-1.2a109 109 0 0 1 29.9-3.6c11.7 0 22.3 1.4 29.8 3.6a1.3 1.3 0 0 1 0 2.4c-7.5 2.2-18 3.6-29.8 3.6" />
		                                <path fill="none" d="M206.1 215.6c-10.6 0-20.2-1.2-27.5-3.1c7.3-2 16.9-3 27.5-3.1a115 115 0 0 1 27.6 3c-7.3 2-17 3.2-27.6 3.2" />
		                                ...
		                                <path fill="#c8b100" d="m182.3 183.8l1.4 1l2-3.2a7 7 0 0 1-3.6-7.2c.2-4.1 5.2-7.6 11.7-7.6q5 .1 8.5 2.4l.2-1.8a17 17 0 0 0-8.7-2.1c-7.4 0-13.2 4.1-13.5 9.1a9 9 0 0 0 3 7.6z" />
		                                <path fill="none" stroke="#000" stroke-width="0.4" d="m182.3 183.8l1.4 1l2-3.2a7 7 0 0 1-3.6-7.2c.2-4.1 5.2-7.6 11.7-7.6q5 .1 8.5 2.4l.2-1.8a17 17 0 0 0-8.7-2.1c-7.4 0-13.2 4.1-13.5 9.1a9 9 0 0 0 3 7.6l-1 1.8" />
		                                ...
		                                <path fill="#c8b100" stroke="#000" stroke-width="0.4" d="M182.7 184a5 5 0 0 1 2.2 2.9s0-.3.6-.6s1-.3 1-.3l-.1 1.3l-.3 2.2l-.7 1.6a2 2 0 0 0-1.5-.4a2 2 0 0 0-1.2.9s-.7-.6-1.2-1.3l-1.1-2l-.7-1.1s.5-.2 1.1 0q.9.1.8.2a5 5 0 0 1 1-3.4m.4 9.8l-.6-1q0-.7.3-1.2s-.9-.5-1.8-.7c-.7-.2-2-.2-2.3-.2h-1l.2.5l.5.7a5 5 0 0 0-3 2a5 5 0 0 0 3.5 1l-.2.8v.6l1-.4c.3-.1 1.5-.5 2-1c.8-.4 1.5-1.1 1.5-1.1m2.7-.5l.2-1.1l-.6-1l1.4-1.3l2-.9l1.1-.4v.6l-.2.8a5 5 0 0 1 3.4 1a5 5 0 0 1-2.9 2l.7 1.2h-1c-.4 0-1.6 0-2.3-.2l-1.8-.7" />
		                                ...
		                                <path fill="none" stroke="#000" stroke-width="0.4" d="M224.2 233.7s-.7.2-1 .6q-.4.9-.3 1c.1.1.6-.5 1.5-.3l1.2.3l1.3-.3s-.7.8-.7 1.3l.2 1.1c0 .7-.6 1.6-.6 1.6l1-.3l1.7-.8l.9-1s-.2 1 0 1.4l.2 1.6l.8-.6q.5-.2.9-.7l.3-1s0 .8.4 1.3l.6 1.6s.3-.8.6-1.1l.7-1l-.1-.9l.4.8m-11 .6s.5-.8 1-1l1.1-.8l.9-.4m1 5l1.3-.8l1-1" />
		                                ...
		                                <path fill="#db4446" d="M217.2 245.8s0 .8.3 1.3c.4.5 1.1.5 1.1.5l-.3-.7l.3-.8q.1-.1-.7-.3z" />
		                                <path fill="none" stroke="#000" stroke-width="0.4" d="M217.2 245.8s0 .8.3 1.3c.4.5 1.1.5 1.1.5l-.3-.7l.3-.8q.1-.1-.7-.3zm16 1.3s2 1.2 1.9 2.2c0 1-1 2.3-1 2.3" />
		                                ...
		                                <path fill="#db4446" d="M239.4 263s-.3.8.2 1.3l1 .5q-.2-.3-.2-1.1q.3-.7.5-.7l-.8-.2l-.7.3" />
		                                <path fill="none" stroke="#000" stroke-width="0.4" d="M239.4 263s-.3.8.2 1.3l1 .5q-.2-.3-.2-1.1q.3-.7.5-.7l-.8-.2l-.7.3z" />
		                                <path fill="#ffd691" stroke="#000" stroke-width="0.5" d="M208.8 316.4q3 1 3 3.8c0 2.3-2.2 4-5 4c-3 0-5.3-1.7-5.3-4c0-1.7 1-3.6 3-3.8l-.2-.4l-.7-.7h1.2l.8.5l.5-.7l.6-.5l.6.6l.3.5l.7-.4l.8-.3s0 .4-.2.7l-.1.7" />
		                                ...
		                                <path fill="#c8b100" d="M237.6 223.4h-.3l-.3.4q-.4.3-.8 0l-.1-.4h-.5q-.4-.3-.1-.7v-.5h-.3l-.1.2q-.3.4-.7.2v-.2h-.3c-.5.2-.7-1-.7-1.2l-.2.2s.2.7.1 1.2l-.3 1.2a9 9 0 0 1 2.9 1.6a9 9 0 0 1 2.2 2.3l1.2-.5c.6-.2 1.3-.2 1.3-.2l.2-.2c-.3 0-1.5.1-1.5-.4v-.2h-.2q-.3-.3 0-.7l.2-.1v-.3h-.3l-.2.1q-.4.5-.8 0l-.1-.4h-.5q-.4-.3 0-.8l.2-.3z" />
		                                <path fill="none" stroke="#000" stroke-width="0.3" d="M237.6 223.4h-.3l-.3.4q-.4.3-.8 0l-.1-.4h-.5q-.4-.3-.1-.7v-.5h-.3l-.1.2q-.3.4-.7.2v-.2h-.3c-.5.2-.7-1-.7-1.2l-.2.2s.2.7.1 1.2l-.3 1.2a9 9 0 0 1 2.9 1.6a9 9 0 0 1 2.2 2.3l1.2-.5c.6-.2 1.3-.2 1.3-.2l.2-.2c-.3 0-1.5.1-1.5-.4v-.2h-.2q-.3-.3 0-.7l.2-.1v-.3h-.3l-.2.1q-.4.5-.8 0l-.1-.4h-.5q-.4-.3 0-.8l.2-.3z" />
                            ...
                            <div className="line2">
                                <p className="info">Núm. 145</p>
                                <p className="info">Martes 17 de junio de 2025</p>
                                <p className="info">Sic. I. &nbsp;&nbsp; Pág. 79112</p>
                            </div>
                        </div>
                    </div>
                </div>
